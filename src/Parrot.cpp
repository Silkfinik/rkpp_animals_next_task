...
void Parrot::MakeSound() const { std::cout << "Squawk!" << std::endl; }

void Parrot::SetLexicon(const int16_t& _lexicon) { lexicon = _lexicon; }

int16_t Parrot::GetLexicon() const { return lexicon.value(); }
